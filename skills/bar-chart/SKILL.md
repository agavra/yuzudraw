...
```
rect "" id bar1 at <bar_col>,<row> size <width>x1 fill block char "▓" noborder
```
...
```
rect "" id seg1 at <bar_col>,<row> size <seg1_width>x1 fill block char "▓" noborder
rect "" id seg2 at <bar_col + seg1_width>,<row> size <seg2_width>x1 fill block char "▒" noborder
```
...
layer "Chart" visible
  group "Bar Chart"
    ...
    text "APAC" at 2,3
    rect "" id bar1 at 10,3 size 50x1 fill block char "▓" noborder
    text "$1.00" at bar1.right+1,0
    text "EMEA" at 2,4
    rect "" id bar2 at 10,4 size 35x1 fill block char "▓" noborder
    text "$0.70" at bar2.right+1,0
    text "AMER" at 2,5
    rect "" id bar3 at 10,5 size 22x1 fill block char "▓" noborder
...
layer "Chart" visible
  group "Bar Chart"
    ...
    text "before" at 2,3
    rect "" id s1a at 10,3 size 14x1 fill block char "▓" noborder
    rect "" id s1b at 24,3 size 36x1 fill block char "▒" noborder
    text "$1.00" at s1b.right+1,0
    text "after" at 2,4
    rect "" id s2a at 10,4 size 14x1 fill block char "▓" noborder
    rect "" id s2b at 24,4 size 13x1 fill block char "▒" noborder
...
layer "Layer 1" visible
  group "Chart 1"
    ...
    rect "" id c1s1b at 35,10 size 36x1 fill block char "▒" noborder
    rect "" id c1s2a at 21,11 size 7x1 fill block char "▓" noborder
    rect "" id c1s2b at 28,11 size 36x1 fill block char "▒" noborder
  ...
  group "Chart 2"
    ...
    rect "" id c2s1a at 21,17 size 14x1 fill block char "▓" noborder
    rect "" id c2s1b at 35,17 size 36x1 fill block char "▒" noborder
    rect "" id c2s2a at 21,18 size 14x1 fill block char "▓" noborder
    rect "" id c2s2b at 35,18 size 13x1 fill block char "▒" noborder
  ...
  group "Legend"
    ...
    rect "" at 56,5 size 7x1 fill block char "▓" noborder
    rect "" at 56,6 size 7x1 fill block char "▒" noborder
...
- Bars use `fill block char "▓"` (or `"▒"`) and `noborder` — height is always 1
